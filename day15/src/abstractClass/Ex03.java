...
// interface 는 extends 가 아니라, implements 키워드로 상속처리한다 (인터페이스를 구현한다라고 표현)
...
interface Test3 {
	...
	// final이므로 한번 지정된 값을 변경할 수 없으며, 반드시 초기값을 지정해야만 한다
...
public class Ex03 {
	public static void main(String[] args) {
		Test3.method2();
//		Test3 ob = new Tet3();	// 인터페이스는 추상 클래스이므로, 생성자를 통한 객체 직접 생성이 불가능하다
		Test4 ob1 = new Test4();
		ob1.method1();

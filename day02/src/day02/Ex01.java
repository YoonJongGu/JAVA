...
public class Ex01 {
	public static void main(String[] args) throws Exception{
		...
		// System.out.println(10 / 3);			// 1번 통로 : 검은색(정상적인 출력결과)
		// System.out.println(10 / 0);			// 2번 통로 : 빨간색(비정상적인 출력결과)
		
		System.out.println("아무키나 입력 하세요 : ");
		// keyCode를 정수로 입력받는다
		int data = System.in.read();			// 0번 통로 : 초록색(입력) -> 모든 데이터는 숫자로 들어간다(자동 형변환을 이용해 출력한다)

...
class Todo implements Comparable<Todo>, Serializable {
	...
	// 2) 저장 이후 우클릭 - s, o (필드를 매개변수를 전달받는 생성자 자동 작성)
...
public class Ex03 {
	public static void main(String[] args) throws ParseException, IOException {
		...
		list.add(new Todo("김도X 생일", sdf.parse("2022.11.04")));
		list.add(new Todo("응용SW평가(필기)", sdf.parse("2022.11.15")));
		list.add(new Todo("김대X 생일", sdf.parse("2022.12.19")));
		list.add(new Todo("강사님 생일", sdf.parse("2022.12.22")));

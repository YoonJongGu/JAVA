...
class Student2 {
	...
	// 필드에 접근 할 수 없기 때문에, 필드의 값을 반환하는 함수(getter)를 만들어야 한다
...
public class Ex02 {
	public static void main(String[] args) {
		...
		System.out.println(st1.name + "의 정수는 " + st1.score + "점 입니다");
...
//		System.out.println(st2.name + "의 점수는 " + st2.score + "점 입니다");
		...
		// Student2 클래스에서는 값을 대입하는 함수(setter)가 없기 떄문에
		// 값을 임의로 수정할 수 없는 상태이다
		
		// 일반적으로 클래스를 작성할 때, field는 private를 적용
		// 메서드는 public을 적용
